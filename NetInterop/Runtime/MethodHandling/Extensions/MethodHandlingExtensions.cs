...
namespace NetInterop.Runtime.Extensions
{
    public static class MethodHandlingExtensions
    {
        ...
        public static INetPtr Register<TResult>(this IMethodHandler handler, MethodInfo method) => handler.Register(method);
        public static INetPtr Register<TResult>(this IMethodHandler handler, Func<TResult> staticMethod) => handler.Register(staticMethod.Method);
        public static INetPtr Register<T, TResult>(this IMethodHandler handler, Func<T, TResult> staticMethod) => handler.Register(staticMethod.Method);
        public static INetPtr Register<T1, T2, TResult>(this IMethodHandler handler, Func<T1, T2, TResult> staticMethod) => handler.Register(staticMethod.Method);
        public static INetPtr Register<T1, T2, T3, TResult>(this IMethodHandler handler, Func<T1, T2, T3, TResult> staticMethod) => handler.Register(staticMethod.Method);
        public static INetPtr Register<T1, T2, T3, T4, TResult>(this IMethodHandler handler, Func<T1, T2, T3, T4, TResult> staticMethod) => handler.Register(staticMethod.Method);
        public static INetPtr Register<T1, T2, T3, T4, T5, TResult>(this IMethodHandler handler, Func<T1, T2, T3, T4, T5, TResult> staticMethod) => handler.Register(staticMethod.Method);
        ...
        public static INetPtr Register<TDeclaring, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
        public static INetPtr Register<TDeclaring, T, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<T, TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
        public static INetPtr Register<TDeclaring, T1, T2, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<T1, T2, TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
        public static INetPtr Register<TDeclaring, T1, T2, T3, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<T1, T2, T3, TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
        public static INetPtr Register<TDeclaring, T1, T2, T3, T4, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<T1, T2, T3, T4, TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
        public static INetPtr Register<TDeclaring, T1, T2, T3, T4, T5, TResult>(this IMethodHandler handler, Expression<Func<TDeclaring, Func<T1, T2, T3, T4, T5, TResult>>> expression) => handler.Register(GetMethodFromExpression(expression.Body));
